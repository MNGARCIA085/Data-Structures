/*
Considere la siguiente especificación del TAD Tabla (función parcial) de int (dominio) en float (imagen o
codominio), donde se estima la cantidad total de correspondencias, que no es una cota estricta.*/
